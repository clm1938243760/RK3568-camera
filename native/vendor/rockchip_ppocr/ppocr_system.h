...
typedef struct {
    ...
    int model_width;
    int model_height;
    rknn_tensor_mem* bound_input_mem;
    rknn_tensor_mem* bound_output_mem;
    unsigned char* staging_input;
    size_t staging_input_size;
} rknn_app_context_t;
...
typedef struct {
    ...
    double recognition_postprocess_ms;
    int recognition_count;
} ppocr_runtime_timing_t;
