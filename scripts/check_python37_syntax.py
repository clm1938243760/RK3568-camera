...
PRODUCTION_FILES = (
    ...
    "scripts/benchmark_same_image_pipeline.py",
    "scripts/convert_docaligner_rknn.py",
    "scripts/convert_ppocr_det_rknn.py",
    "scripts/create_ppocr_det_candidate.py",
    "scripts/compare_benchmarks.py",
    "scripts/collect_e2e_timings.py",
    "scripts/monitor_native_stability.py",
    "scripts/native_preview_server.py",
    "report_parser/scripts/camera_paper_trigger.py",
    "report_parser/scripts/native_structured_worker.py",
    ...
    "report_parser/src/rk3588_report_parser/native_patient_domain.py",
    "report_parser/src/rk3588_report_parser/native_patient_resolver.py",
    ...
    "report_parser/src/rk3588_report_parser/rule_field_resolver.py",
